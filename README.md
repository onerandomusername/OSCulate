...
- [OSCulate](#osculate)
  ...
  - [ETC Trademark Disclosure](#etc-trademark-disclosure)
...
This seems to exists for the official mobile apps to automatically show existing consoles on the network.
...
- SLP protocol support to determine what computers are running Eos,
  - see [Usage of console discovery](#usage-of-console-discovery)
